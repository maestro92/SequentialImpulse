...
class Slider : public Control
{
    ...
    public:
        ...
        virtual bool update(GameInput& state);
        virtual bool update(GameInput& state, unsigned int& groupFlag);
        virtual bool update1(GameInput& state, unsigned int& groupFlag);
